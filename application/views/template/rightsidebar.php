            ...
            <div class="widget-chat-activity flex-1">
                <div class="messages">
                    <div class="message media reply">
                        <figure class="user--online">
                            <a href="#">
                                <img src="<?php echo base_url('assets/img/users/3.jpg'); ?>" class="rounded-circle"
                                    alt="">
                            </a>
                        </figure>
                    ...
                    <div class="message media">
                        <figure class="user--online">
                            <a href="#">
                                <img src="<?php echo base_url('assets/img/users/1.jpg'); ?>" class="rounded-circle"
                                    alt="">
                            </a>
                        </figure>
                        <div class="message-body media-body">
                    ...
                    <div class="message media reply">
                        <figure class="user--offline">
                            <a href="#">
                                <img src="<?php echo base_url('assets/img/users/5.jpg'); ?>" class="rounded-circle"
                                    alt="">
                            </a>
                        </figure>
                        <div class="message-body media-body">
